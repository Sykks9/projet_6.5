...
class line_bonus():
    def __init__(self,display):
        """Classe générant une ligne d'alien bonus
        """
        self.__aliens__=[]
        self.display=display
        for i in range(100,550,50):
            self.__aliens__.append(Alien(i,50,2-(i/50)%2,100,500,self.display))
...
class line_shooter():
    def __init__(self,display):
        ...
        self.display=display
        for i in range(100,550,50):
            self.__aliens__.append(Alien(i,100,1+(i/50)%2,100,500,self.display))
    def delete_alien(self,alien:Alien):
...
class line_normal():
    def __init__(self,display):
        ...
        self.display=display
        for i in range(100,550,50):
            self.__aliens__.append(Alien(i,150,0,100,500,self.display))
    def delete_alien(self,alien:Alien):
        """Cherche et supprime un alien
